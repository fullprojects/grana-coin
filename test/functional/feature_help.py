...
"""Verify that starting granacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start granacoin with -h for help text")
        ...
        self.log.info("Start granacoin with -version for version information")
        ...
        self.log.info("Start granacoind with -fakearg to make sure it does not start")

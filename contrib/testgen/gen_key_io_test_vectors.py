...
bech32_templates = [
  ...
  ('grana',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('grana',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('grana',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tgrana',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tgrana',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tgrana',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rgrana',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rgrana',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rgrana', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tgrana',  17, 32, False, False, False),
  ('rgrana',  3,  1, False, False, False),
  ('grana',   15, 41, False, False, False),
  ('tgrana',  0, 16, False, False, False),
  ('rgrana',  0, 32, True,  False, False),
  ('grana',   0, 16, True,  False, False),
  ('tgrana',  0, 32, False, True,  False),
  ('rgrana',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['grana', 'tgrana', 'rgrana']:

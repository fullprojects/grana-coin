...
// Copyright (c) 2020 The Grana Coin developers
...
{
    const char* pszTimestamp = "BBC NEWS 26/Apr/2020 Coronavirus: French police seize 140,000 black market masks";
    const CScript genesisOutputScript = CScript() << ParseHex("049180a6d55e1b4dfeaf78ee4fef541fb4c6c55c89f99f68e94018be6a2f8abcba702b49ca63623f661b3289087f923ea7f055985b9617e726ff6e2b85af528584") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1587927882, 2084556931, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7c537e09c9df7c2712d32876c94af2dc417016f2e6a029dc41cf1145897f947e"));
        assert(genesis.hashMerkleRoot == uint256S("0xf8c956c25ee65bf75ae64e76277e1564ba1249da584e5d7c4213b00c55191a4a"));
        ...
        //vSeeds.emplace_back("seed-a.granacoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.granacointools.com");
        //vSeeds.emplace_back("dnsseed.granacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1587927882, 50493345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7c537e09c9df7c2712d32876c94af2dc417016f2e6a029dc41cf1145897f947e"));
        assert(genesis.hashMerkleRoot == uint256S("0xf8c956c25ee65bf75ae64e76277e1564ba1249da584e5d7c4213b00c55191a4a"));
        ...
        //vSeeds.emplace_back("testnet-seed.granacointools.com");
        //vSeeds.emplace_back("seed-b.granacoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1587927882, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7c537e09c9df7c2712d32876c94af2dc417016f2e6a029dc41cf1145897f947e"));
        assert(genesis.hashMerkleRoot == uint256S("0xf8c956c25ee65bf75ae64e76277e1564ba1249da584e5d7c4213b00c55191a4a"));
